...
export const CampaignPipeline = ({ userId }) => {
  ...
  const replyRate = totalCampaigns > 0 ? ((repliedCount / totalCampaigns) * 100).toFixed(1) : 0;

  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Outreach Pipeline</h2>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-3xl font-bold text-blue-600">{campaigns.sent?.length || 0}</p>
          </div>
            ...
            <div key={status} className="flex flex-col">
              <div className="mb-4">
                ...
                <p className="text-sm text-slate-600">
                  {campaigns[status]?.length || 0} campaigns
                </p>
              </div>
              ...
              <div className="space-y-3 flex-1 min-h-[500px] bg-slate-50 rounded-lg p-4">
                {campaigns[status]?.map(campaign => (
                  <div
                    ...
                    draggable
                    className="p-4 bg-white rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-shadow cursor-move"
                  >
                    <div className="mb-2">
                    ...
                    {campaign.company_research && (
                      <div className="mb-3 p-2 bg-slate-50 rounded border border-slate-200">
                        ...
                        <p className="text-xs text-slate-600">
                          Health: {campaign.company_research.health_score}
                        </p>
                      </div>
                    )}
